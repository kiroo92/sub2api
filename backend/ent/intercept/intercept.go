...
// The SubscriptionDiscountCodeFunc type is an adapter to allow the use of ordinary function as a Querier.
type SubscriptionDiscountCodeFunc func(context.Context, *ent.SubscriptionDiscountCodeQuery) (ent.Value, error)

// Query calls f(ctx, q).
func (f SubscriptionDiscountCodeFunc) Query(ctx context.Context, q ent.Query) (ent.Value, error) {
	if q, ok := q.(*ent.SubscriptionDiscountCodeQuery); ok {
		return f(ctx, q)
	}
	return nil, fmt.Errorf("unexpected query type %T. expect *ent.SubscriptionDiscountCodeQuery", q)
}

// The TraverseSubscriptionDiscountCode type is an adapter to allow the use of ordinary function as Traverser.
type TraverseSubscriptionDiscountCode func(context.Context, *ent.SubscriptionDiscountCodeQuery) error

// Intercept is a dummy implementation of Intercept that returns the next Querier in the pipeline.
func (f TraverseSubscriptionDiscountCode) Intercept(next ent.Querier) ent.Querier {
	return next
}

// Traverse calls f(ctx, q).
func (f TraverseSubscriptionDiscountCode) Traverse(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.SubscriptionDiscountCodeQuery); ok {
		return f(ctx, q)
	}
	return fmt.Errorf("unexpected query type %T. expect *ent.SubscriptionDiscountCodeQuery", q)
}
...
func NewQuery(q ent.Query) (Query, error) {
	...
	case *ent.SubscriptionDiscountCodeQuery:
		return &query[*ent.SubscriptionDiscountCodeQuery, predicate.SubscriptionDiscountCode, subscriptiondiscountcode.OrderOption]{typ: ent.TypeSubscriptionDiscountCode, tq: q}, nil
