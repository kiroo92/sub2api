...
type InviteCodeEdges struct {
	...
	Bindings []*InviteBinding `json:"bindings,omitempty"`
...
func (e InviteCodeEdges) UserOrErr() (*User, error) {
	if e.User != nil {
		return e.User, nil
...
func (e InviteCodeEdges) BindingsOrErr() ([]*InviteBinding, error) {
	if e.loadedTypes[1] {
...
func (*InviteCode) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case invitecode.FieldID, invitecode.FieldUserID:
...
// QueryUser queries the "user" edge of the InviteCode entity.
func (_m *InviteCode) QueryUser() *UserQuery {
	return NewInviteCodeClient(_m.config).QueryUser(_m)
}

// QueryBindings queries the "bindings" edge of the InviteCode entity.
func (_m *InviteCode) QueryBindings() *InviteBindingQuery {
	return NewInviteCodeClient(_m.config).QueryBindings(_m)
}
