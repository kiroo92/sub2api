...
func init() {
	...
	apikeyDescRoutingMode := apikeyFields[4].Descriptor()
	...
	// groupDescDisabledMessage is the schema descriptor for disabled_message field.
	groupDescDisabledMessage := groupFields[1].Descriptor()
	// group.DefaultDisabledMessage holds the default value on creation for the disabled_message field.
	group.DefaultDisabledMessage = groupDescDisabledMessage.Default.(string)
	...
	invoicerequestDescStatus := invoicerequestFields[1].Descriptor()
	...
	invoicerequestDescTaxID := invoicerequestFields[2].Descriptor()
	...
	invoicerequestDescTitle := invoicerequestFields[3].Descriptor()
	...
	// invoicerequestDescEmail is the schema descriptor for email field.
	invoicerequestDescEmail := invoicerequestFields[4].Descriptor()
	// invoicerequest.EmailValidator is a validator for the "email" field. It is called by the builders before save.
	invoicerequest.EmailValidator = invoicerequestDescEmail.Validators[0].(func(string) error)
	// invoicerequestDescRemarks is the schema descriptor for remarks field.
	invoicerequestDescRemarks := invoicerequestFields[5].Descriptor()
	// invoicerequest.DefaultRemarks holds the default value on creation for the remarks field.
	invoicerequest.DefaultRemarks = invoicerequestDescRemarks.Default.(string)
	// invoicerequest.RemarksValidator is a validator for the "remarks" field. It is called by the builders before save.
	invoicerequest.RemarksValidator = invoicerequestDescRemarks.Validators[0].(func(string) error)
	// invoicerequestDescCurrency is the schema descriptor for currency field.
	invoicerequestDescCurrency := invoicerequestFields[6].Descriptor()
	...
	// invoicerequestDescItemName is the schema descriptor for item_name field.
	invoicerequestDescItemName := invoicerequestFields[12].Descriptor()
	// invoicerequest.ItemNameValidator is a validator for the "item_name" field. It is called by the builders before save.
	invoicerequest.ItemNameValidator = invoicerequestDescItemName.Validators[0].(func(string) error)
	// invoicerequestDescFeeType is the schema descriptor for fee_type field.
	invoicerequestDescFeeType := invoicerequestFields[14].Descriptor()
	// invoicerequest.FeeTypeValidator is a validator for the "fee_type" field. It is called by the builders before save.
	invoicerequest.FeeTypeValidator = invoicerequestDescFeeType.Validators[0].(func(string) error)
	// invoicerequestDescOperationKey is the schema descriptor for operation_key field.
	invoicerequestDescOperationKey := invoicerequestFields[17].Descriptor()
	// invoicerequest.OperationKeyValidator is a validator for the "operation_key" field. It is called by the builders before save.
	invoicerequest.OperationKeyValidator = invoicerequestDescOperationKey.Validators[0].(func(string) error)
	// invoicerequestDescFingerprint is the schema descriptor for fingerprint field.
	invoicerequestDescFingerprint := invoicerequestFields[18].Descriptor()
	// invoicerequest.FingerprintValidator is a validator for the "fingerprint" field. It is called by the builders before save.
	invoicerequest.FingerprintValidator = invoicerequestDescFingerprint.Validators[0].(func(string) error)
	// invoicerequestDescCreatedAt is the schema descriptor for created_at field.
	invoicerequestDescCreatedAt := invoicerequestFields[23].Descriptor()
	...
	// invoicerequestorderDescOrderNo is the schema descriptor for order_no field.
	invoicerequestorderDescOrderNo := invoicerequestorderFields[2].Descriptor()
	// invoicerequestorder.OrderNoValidator is a validator for the "order_no" field. It is called by the builders before save.
	invoicerequestorder.OrderNoValidator = invoicerequestorderDescOrderNo.Validators[0].(func(string) error)
	// invoicerequestorderDescOrderType is the schema descriptor for order_type field.
	invoicerequestorderDescOrderType := invoicerequestorderFields[3].Descriptor()
	// invoicerequestorder.OrderTypeValidator is a validator for the "order_type" field. It is called by the builders before save.
	invoicerequestorder.OrderTypeValidator = invoicerequestorderDescOrderType.Validators[0].(func(string) error)
	// invoicerequestorderDescName is the schema descriptor for name field.
	invoicerequestorderDescName := invoicerequestorderFields[4].Descriptor()
	// invoicerequestorder.NameValidator is a validator for the "name" field. It is called by the builders before save.
	invoicerequestorder.NameValidator = invoicerequestorderDescName.Validators[0].(func(string) error)
	...
	// paymentorderDescDiscountState is the schema descriptor for discount_state field.
	paymentorderDescDiscountState := paymentorderFields[8].Descriptor()
	// paymentorder.DefaultDiscountState holds the default value on creation for the discount_state field.
	paymentorder.DefaultDiscountState = paymentorderDescDiscountState.Default.(string)
	// paymentorder.DiscountStateValidator is a validator for the "discount_state" field. It is called by the builders before save.
	paymentorder.DiscountStateValidator = paymentorderDescDiscountState.Validators[0].(func(string) error)
	...
	subscriptiondiscountcodeFields := schema.SubscriptionDiscountCode{}.Fields()
	_ = subscriptiondiscountcodeFields
	// subscriptiondiscountcodeDescCode is the schema descriptor for code field.
	subscriptiondiscountcodeDescCode := subscriptiondiscountcodeFields[0].Descriptor()
	// subscriptiondiscountcode.CodeValidator is a validator for the "code" field. It is called by the builders before save.
	subscriptiondiscountcode.CodeValidator = func() func(string) error {
		validators := subscriptiondiscountcodeDescCode.Validators
		fns := [...]func(string) error{
			validators[0].(func(string) error),
			validators[1].(func(string) error),
		}
	...
	// subscriptiondiscountcodeDescDiscountType is the schema descriptor for discount_type field.
	subscriptiondiscountcodeDescDiscountType := subscriptiondiscountcodeFields[1].Descriptor()
	// subscriptiondiscountcode.DiscountTypeValidator is a validator for the "discount_type" field. It is called by the builders before save.
	subscriptiondiscountcode.DiscountTypeValidator = subscriptiondiscountcodeDescDiscountType.Validators[0].(func(string) error)
	// subscriptiondiscountcodeDescPlanIds is the schema descriptor for plan_ids field.
	subscriptiondiscountcodeDescPlanIds := subscriptiondiscountcodeFields[3].Descriptor()
	// subscriptiondiscountcode.DefaultPlanIds holds the default value on creation for the plan_ids field.
	subscriptiondiscountcode.DefaultPlanIds = subscriptiondiscountcodeDescPlanIds.Default.([]int64)
	// subscriptiondiscountcodeDescEnabled is the schema descriptor for enabled field.
	subscriptiondiscountcodeDescEnabled := subscriptiondiscountcodeFields[4].Descriptor()
	// subscriptiondiscountcode.DefaultEnabled holds the default value on creation for the enabled field.
	subscriptiondiscountcode.DefaultEnabled = subscriptiondiscountcodeDescEnabled.Default.(bool)
	// subscriptiondiscountcodeDescMaxUses is the schema descriptor for max_uses field.
	subscriptiondiscountcodeDescMaxUses := subscriptiondiscountcodeFields[6].Descriptor()
	// subscriptiondiscountcode.DefaultMaxUses holds the default value on creation for the max_uses field.
	subscriptiondiscountcode.DefaultMaxUses = subscriptiondiscountcodeDescMaxUses.Default.(int)
	// subscriptiondiscountcode.MaxUsesValidator is a validator for the "max_uses" field. It is called by the builders before save.
	subscriptiondiscountcode.MaxUsesValidator = subscriptiondiscountcodeDescMaxUses.Validators[0].(func(int) error)
	// subscriptiondiscountcodeDescPerUserLimit is the schema descriptor for per_user_limit field.
	subscriptiondiscountcodeDescPerUserLimit := subscriptiondiscountcodeFields[7].Descriptor()
	// subscriptiondiscountcode.DefaultPerUserLimit holds the default value on creation for the per_user_limit field.
	subscriptiondiscountcode.DefaultPerUserLimit = subscriptiondiscountcodeDescPerUserLimit.Default.(int)
	// subscriptiondiscountcode.PerUserLimitValidator is a validator for the "per_user_limit" field. It is called by the builders before save.
	subscriptiondiscountcode.PerUserLimitValidator = subscriptiondiscountcodeDescPerUserLimit.Validators[0].(func(int) error)
	// subscriptiondiscountcodeDescCreatedAt is the schema descriptor for created_at field.
	subscriptiondiscountcodeDescCreatedAt := subscriptiondiscountcodeFields[8].Descriptor()
	// subscriptiondiscountcode.DefaultCreatedAt holds the default value on creation for the created_at field.
	subscriptiondiscountcode.DefaultCreatedAt = subscriptiondiscountcodeDescCreatedAt.Default.(func() time.Time)
	// subscriptiondiscountcodeDescUpdatedAt is the schema descriptor for updated_at field.
	subscriptiondiscountcodeDescUpdatedAt := subscriptiondiscountcodeFields[9].Descriptor()
	// subscriptiondiscountcode.DefaultUpdatedAt holds the default value on creation for the updated_at field.
	subscriptiondiscountcode.DefaultUpdatedAt = subscriptiondiscountcodeDescUpdatedAt.Default.(func() time.Time)
	// subscriptiondiscountcode.UpdateDefaultUpdatedAt holds the default value on update for the updated_at field.
	subscriptiondiscountcode.UpdateDefaultUpdatedAt = subscriptiondiscountcodeDescUpdatedAt.UpdateDefault.(func() time.Time)
	...
	// usersubscriptionDescSortOrder is the schema descriptor for sort_order field.
