...
func (_u *GroupUpdate) SetDisabledMessage(v string) *GroupUpdate {
	_u.mutation.SetDisabledMessage(v)
	return _u
}

// SetNillableDisabledMessage sets the "disabled_message" field if the given value is not nil.
func (_u *GroupUpdate) SetNillableDisabledMessage(v *string) *GroupUpdate {
	if v != nil {
		_u.SetDisabledMessage(*v)
	}
	return _u
}
...
func (_u *GroupUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.DisabledMessage(); ok {
...
// SetDisabledMessage sets the "disabled_message" field.
func (_u *GroupUpdateOne) SetDisabledMessage(v string) *GroupUpdateOne {
	_u.mutation.SetDisabledMessage(v)
	return _u
}

// SetNillableDisabledMessage sets the "disabled_message" field if the given value is not nil.
func (_u *GroupUpdateOne) SetNillableDisabledMessage(v *string) *GroupUpdateOne {
	if v != nil {
		_u.SetDisabledMessage(*v)
	}
	return _u
