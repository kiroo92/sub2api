...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	teamRepository := repository.NewTeamRepository(db, redisClient)
	...
	teamService := service.NewTeamService(teamRepository, apiKeyService, settingRepository, notificationEmailService, billingCacheService)
	...
	subscriptionService := service.ProvideSubscriptionService(groupRepository, userSubscriptionRepository, billingCacheService, client, configConfig, accountRepository, compositeRouteResolver, channelService, userGroupRateRepository, teamRepository, userRepository)
	...
	openAIGatewayHandler := handler.ProvideOpenAIGatewayHandler(subscriptionService, openAIGatewayService, pluginManager, concurrencyService, billingCacheService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, contentModerationService, opsService, grokQuotaService, configConfig, coordinator)
