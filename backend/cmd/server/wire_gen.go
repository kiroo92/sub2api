...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	inviteRepository := repository.NewInviteRepository(client, db)
	inviteService := service.NewInviteService(inviteRepository, settingService)
	...
	userHandler := handler.NewUserHandler(userService, inviteService)
