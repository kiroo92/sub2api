...
// Personal navigation items include the user's dashboard and subscriptions.
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/teams', label: t('team.adminTitle'), icon: UsersIcon, hideInSimpleMode: true },
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/admin/orders/invoices', label: t('invoices.management'), icon: OrderIcon },
        { path: '/admin/orders/plans', label: t('nav.paymentPlans'), icon: CreditCardIcon },
        { path: '/admin/orders/discount-codes', label: t('payment.coupon.management'), icon: GiftIcon },
      ],
    },
