export default {
  ...
  payment: {
    ...
    subscriptionPlansTitle: 'Choose your subscription',
    independentSubscriptionTitle: 'Buy again as a separate subscription',
    independentSubscriptionHint: 'Each purchase creates an independent subscription with its own quota and validity period. Repeat purchases do not extend an existing subscription.',
    renewNow: 'Renew',
