export default {
  dashboard: {
    title: '仪表盘',
    overviewHint: '查看账户用量，管理订阅权益。',
    refreshOverview: '刷新概览',
    walletBalance: '钱包余额',
    subscriptionCost: '套餐',
    balanceCost: '余额',
    actualCostHint: '按实际扣费统计',
    unavailable: '暂不可用',
    statsLoadFailed: '用量统计加载失败，请重试。',
    balanceLoadFailed: '余额加载失败',
    quotasLoadFailed: '平台额度加载失败，请重试。',
  ...
  keys: {
    ...
    routingMode: '计费来源',
    fixedGroup: '固定分组',
    allSubscriptionsHint: '按我的订阅顺序自动使用可用额度',
    usage: '用量',
    today: '今日',
    total: '近30天',
    quota: '额度',
