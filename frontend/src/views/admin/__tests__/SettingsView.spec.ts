...
describe("admin SettingsView payment visible method controls", () => {
  ...
  it("loads and saves custom menu button visibility without losing the open mode", async () => {
    const menuItems = [
      { id: "docs", label: "Docs", url: "https://example.com/docs", icon_svg: "", visibility: "user", sort_order: 0 },
      { id: "help", label: "Help", url: "https://example.com/help", icon_svg: "", visibility: "user", sort_order: 1, open_mode: "new_tab", hide_open_button: true },
    ];
